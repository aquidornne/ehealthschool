        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php echo $this->Form->create('User', array('type' => 'GET', 'controller' => 'Students', 'action' => 'index')); ?>
                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach($list as $row): ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['User']['password_2']; ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo $this->Html->url(array('controller' => 'Students', 'action' => 'edit', $row['User']['id'])); ?>" class="btn btn-info"><i class="fa big fa-pencil pull-right"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
