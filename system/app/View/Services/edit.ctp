<div class="row border-bottom white-bg dashboard-header">
    <h2 class="noMarginTop">Editar Serviço</h2>
    <?php //echo $this->element('breadcrumb'); ?>
</div>

<div class="wrapper wrapper-content animated fadeInRight">
    <?php echo $this->Form->create('Service', array('id' => 'form_edit', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal m-t-md')); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <?php if(!empty($this->data['Service']['cover'])){ ?>
                                        <a href="<?php echo $this->webroot . 'files/services/' . $this->data['Service']['cover']; ?>" class="fancybox">
                                            <img src="<?php echo $this->webroot . 'files/services/' . $this->data['Service']['cover']; ?>">
                                        </a>
                                    <?php } ?>
                                </div>
                            </div>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <div class="col-sm-4 pull-right">
                    <?php echo $this->Form->hidden('Service.id', array('value' => $id)); ?>
                    <?php echo $this->Form->hidden('Service.client_id', array('value' => $this->data['Service']['client_id'])); ?>
                    <?php echo $this->Form->hidden('Service.cover_old', array('value' => $this->data['Service']['cover'])); ?>

                    <a href="<?php echo $this->Html->url(array('action' => 'index', $this->data['Service']['client_id'])); ?>" class="btn btn-default" type="submit">Cancelar</a>
