<div class="row border-bottom white-bg dashboard-header">
    <h2 class="noMarginTop">Cadastrar Conta</h2>
...
<script>
    ...
    $('#btn_submit').click(function (e){
        ...
        if (!$('#photo').val()) {
            application.inlineFieldAlert('add', 'input-prepend', $('#photo'), 'Insira o arquivo.', 'warning', false);
            error.push(18);
        } else {
            application.inlineFieldAlert('clean', 'input-prepend', $('#photo'));
        }
