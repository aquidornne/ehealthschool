<div class="row border-bottom white-bg dashboard-header">
    <h2 class="noMarginTop">Categorias</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <?php foreach($list as $key => $row){ ?>
                                <tr>
                                    <td><?php echo $row['CourseCategory']['name']; ?></td>
                                    <td>
                                        <a href="<?php echo $this->Html->url(array('action' => 'edit', $row['CourseCategory']['id'])); ?>" class="btn btn-info"><i class="fa big fa-pencil pull-right"></i></a>
                                        <a href="<?php echo $this->Html->url(array('action' => 'remove', $row['CourseCategory']['id'])); ?>" class="btn btn-danger confirm"><i class="fa big fa-trash pull-right"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
