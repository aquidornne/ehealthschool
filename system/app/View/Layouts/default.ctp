...
<html>
    <head>
        ...
        <link href="<?php echo $this->webroot; ?>js/plugins/datepicker/css/bootstrap-datepicker3.css" rel="stylesheet">
        <script src="<?php echo $this->webroot; ?>js/plugins/datepicker/js/bootstrap-datepicker.js"></script>
        <script src="<?php echo $this->webroot; ?>js/plugins/datepicker/locales/bootstrap-datepicker.pt-BR.min.js"></script>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo $this->webroot; ?>js/plugins/jquery-te/jquery-te-1.4.0.css">
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/plugins/jquery-te/jquery-te-1.4.0.min.js" charset="utf-8"></script>
    ...
    <body class="">
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $('.jqte').jqte({format: false, fsize: false});
                $("a.fancybox").fancybox();
            });
        </script>
