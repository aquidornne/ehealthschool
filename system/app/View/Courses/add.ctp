<div class="row border-bottom white-bg dashboard-header">
    <h2 class="noMarginTop">Cadastrar Curso</h2>
    <?php //echo $this->element('breadcrumb'); ?>
</div>

<div class="wrapper wrapper-content animated fadeInRight">
    <?php echo $this->Form->create('Course', array('id' => 'form_add', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal m-t-md')); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="col-lg-12 m-b">
                                    ...
                                    <?php echo $this->Form->input('teachers', array('div' => FALSE, 'label' => FALSE, 'class' => 'form-control chosen-select', 'options' => $teachers, 'empty' => TRUE, 'multiple' => 'multiple', 'data-placeholder' => 'Selecione os Professores')); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 m-b">
