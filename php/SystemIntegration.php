...
class SystemIntegration
{
    ...
    protected $_domain = 'fusioncomunicacao.com/clientes/ehealthschool/system';
    ...
    function __construct($config)
    {
        ...
        if (isset($config['sandbox']) and $config['sandbox']) {
            ...
            $this->_webservice = (($this->_trustForwarded) ? 'https://' : 'http://') . 'localhost/SERVICOS/ehealthschool/system' . '/' . $this->_controller . '/';
        } else {
    ...
    public function serviceFindBanners($data)
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }

    #- -------------------------------------------------------------------------------------------------------------
    public function serviceFindCourseByUrl($data)
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }

    #- -------------------------------------------------------------------------------------------------------------
    public function serviceFindAllCourse($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
    ...
    #- -------------------------------------------------------------------------------------------------------------
    public function serviceFindUserByCpf($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
    ...
    #- -------------------------------------------------------------------------------------------------------------
    public function serviceFindSale($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
    ...
    #- -------------------------------------------------------------------------------------------------------------
    public function serviceSaveUser($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
    ...
    #- -------------------------------------------------------------------------------------------------------------
    public function serviceSaveSale($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
    ...
    #- -------------------------------------------------------------------------------------------------------------
    public function serviceSaveNewsletters($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
    ...
    #- -------------------------------------------------------------------------------------------------------------
    public function serviceLogin($data = array())
    {
        return $this->transmitData(__FUNCTION__, array('data' => $data, 'clientSecretKey' => $this->clientSecretKey));
    }
    #- -------------------------------------------------------------------------------------------------------------
